...
import com.blog.ApiRestblog.informatorio.Servicio.UsuarioService;
...
public class UsuarioController {
    ...
    @Autowired
    OtroUsuarioRepository SegundoUsuarioRepository;
    ...
    public PostModel crearPostDadoUsuario(@PathVariable Long id_user,@RequestBody PostModel post) {
        UsuarioModel usuario = SegundoUsuarioRepository.getOne(id_user);
    ...
    public ResponseEntity<?> buscarFechaPosterior(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate fecha){
        ...
        try{
            ...
            List <UsuarioModel> usuarios = SegundoUsuarioRepository.findByFechaDeCreacionAfter(fecha);
    ...
    public ResponseEntity<?> updateUsuario(@PathVariable("usuarioId") Long usuarioId,@RequestBody UsuarioModel usuario){
        ...
        UsuarioModel usuarioExistente = SegundoUsuarioRepository.findById(usuarioId).get();;
        ...
        return new ResponseEntity<>(SegundoUsuarioRepository.save(usuario), HttpStatus.OK);
    }    
